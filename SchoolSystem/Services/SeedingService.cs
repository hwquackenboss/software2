...
public class SeedingService {
    ...
    public async Task SeedDatabase() {
        ...
        CreateCourse("Data Structures", instructorAlan, csDeptId);
        CreateCourse("Computer Networks", instructorAlan, csDeptId);
        CreateCourse("Operating Systems", instructorAlan, csDeptId);

        CreateCourse("Linear Algebra", instructorJane, mathDeptId);
        CreateCourse("Statistics", instructorJane, mathDeptId);
        CreateCourse("Calculus", instructorJane, mathDeptId);

        CreateCourse("Particle Physics", instructorJohn, physicsDeptId);
        CreateCourse("Quantum Mechanics", instructorJohn, physicsDeptId);
